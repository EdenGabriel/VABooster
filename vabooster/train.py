...
from vabooster.config import BaseOptions
from vabooster.start_end_dataset import \
...
from vabooster.inference import eval_epoch, start_inference, setup_model
...
def train_epoch(model, criterion, train_loader, optimizer, opt, epoch_i, tb_writer):
    ...
    for batch_idx, batch in tqdm(enumerate(train_loader),
        ...
        #     momentum = 0.9 # settings.EM_MOM
        #     model.mu *= momentum
        #     model.mu += mu * (1 - momentum)
