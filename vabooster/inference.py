...
from vabooster.config import TestOptions
from vabooster.model import build_model
from vabooster.span_utils import span_cxw_to_xx
from vabooster.start_end_dataset import StartEndDataset, start_end_collate, prepare_batch_inputs
from vabooster.start_end_dataset_audio import \
    StartEndDataset_audio, start_end_collate_audio, prepare_batch_inputs_audio

from vabooster.postprocessing_cg_detr import PostProcessorDETR
...
def compute_mr_results(model, eval_loader, opt, epoch_i=None, criterion=None, tb_writer=None):
    ...
    for batch in tqdm(eval_loader, desc="compute st ed scores"):
        ...
        # print("GFLOPs, params(M):",flops/1e9, params/1e6) # ourbest model: flops, params: 0.438004576GFLOPs 7.514389M
        #                                       # inter-modality:ca + global: rw flops, params: 0.517108576GFLOPs 8.567575M
        #                                       # inter-modality:ca + global: ca flops, params:  0.518163296GFLOPs 8.567575M
...
def setup_model(opt):
    ...
    # param_dicts = [
    #     {'params': other_params},
    #     {'params': gmm_params,'lr': 10*opt.lr},
    # ]
